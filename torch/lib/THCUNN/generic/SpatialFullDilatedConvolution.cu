           ...
           int adjW, int adjH)
{
  ...
  THNN_(SpatialFullDilatedConvolution_shapeCheck)
       (state, input, NULL, weight, bias, kH, kW, dH, dW, padH, padW, dilationW, dilationH, adjH, adjW);
           ...
           int adjW, int adjH)
{
  ...
  THNN_(SpatialFullDilatedConvolution_shapeCheck)
       (state, input, gradOutput, weight, NULL, kH, kW, dH, dW, padH, padW, dilationW, dilationH, adjH, adjW);
           ...
           accreal scale_)
{
  ...
  THNN_(SpatialFullDilatedConvolution_shapeCheck)
       (state, input, gradOutput, gradWeight, gradBias, kH, kW, dH, dW, padH, padW, dilationW, dilationH, adjH, adjW);
